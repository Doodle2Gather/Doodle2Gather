...
extension DTError: AbortError {
  public var status: HTTPResponseStatus {
    ...
    case .missingParameter: return .badRequest
    case .invalidParameterFormat: return .badRequest
    case .modelNotFound: return .notFound
    case .unableToRetreiveID: return .internalServerError
    case .other: return .internalServerError
    }
  }
}
